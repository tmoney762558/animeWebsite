...
const TopAnime = ({ animeData, onRecieveData, setPreviousPage }) => {
  return (
        ...
        {animeData.map((anime, index) => {
          ...
          return (
            <div className="flex flex-col items-center" key={index} onClick={() => {
              ...
              ></img>
              <h3 className="text-xl text-center">{anime.title_english}</h3>
              <h4 className="text-lg text-center">{anime.title_japanese}</h4>
            </div>
          );
        })}
      </div>
